...
@section('content')
    <div class="container">
        <button data-toggle="modal" data-target="#addKlasifikasi" class="btn btn-primary btn-md mb-2">Buat Klasifikasi
            Surat</button>
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 table">
                        <table class="table table-bordered klasifikasi_datatable" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th> Klasifikasi</th>
