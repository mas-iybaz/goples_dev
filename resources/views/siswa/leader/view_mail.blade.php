...
@section('title', 'Pimpinan | Lihat Surat')
...
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if ($mail->autograph_status == 0)
                        <p> Belum Disetujui </p>
                        <a href="{{ route('approve_sign', $mail->outboxID) }}"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                        ...
                        <a href="" target="_blank" class="btn btn-lg bg-light btn-block ">
                            <i class="fa fa-file fa-4x pull-center text-info">
                            </i>
                        </a>
                        <a href="" download
        ...
        <div class="col-md-8">
            ...
            @endif
            <div class="card">
                <div class="card-body preview-mail">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <hr>
                    <h6>Masukkan Data Koreksi</h6>
                    <form action="{{ route('add_mail_correct') }}" method="post">
                        {{ csrf_field() }}

                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Instruksi</label>
                            <div class="col-sm-10">
                                <textarea height="100px" class="form-control" id="inp_klasifikasi" placeholder="Masukkan Instruksi"
                                    name='isi_instruksi'></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleFormControlSelect1" class="col-sm-2 col-form-label">Status Koreksi
                                Surat</label>
                            <div class="col-sm-10">
                                <select class="form-control" id="exampleFormControlSelect1" name="status_koreksi"
                                    required>
                                    <option value="">Pilih Status Koreksi Surat ... </option>
                                    <option value="0">Masih Perlu Revisi</option>
                                    <option value="1">Disetujui</option>

                                </select>
                                <input type="hidden" name="outbox_id" value="{{ $mail->outboxID }}">
                            </div>
                        </div>
                </div>
