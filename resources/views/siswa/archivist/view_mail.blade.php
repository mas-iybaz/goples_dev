    ...
    <div class="row">
                        ...
                        <table class="table table-responsive">
                            ...
                            <tr>
                                ...
                                <td width=70% class="text-wrap">
                                    ...
                                    @if ($mail->retention_status == 1)
                                        {{ 'Ditinjau Kembali' }}
                                    @elseif ($mail->retention_status == 2)
                                        {{ 'Permanen' }}
                                    @elseif ($mail->retention_status == 3)
                                        {{ 'Musnah' }}
                                    @endif
                                </td>
                            </tr>
        ...
        <div class="col-md-8">
            <form action="{{ route('arc_delete_outbox', $mail->outboxID) }}" method="POST">
                ...
                <button type="submit" class="btn btn-danger btn-sm mb-3 mr-3">Hapus Surat</button>
            </form>
