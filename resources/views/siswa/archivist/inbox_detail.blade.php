                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <button data-toggle="modal" data-target="#set_retensi"
                                        class="btn btn-sm bg-danger text-center text-white mt-2 btn-block ">
                                        Atur Retensi Surat
                                    </button>
                                    ...
                                    <button type="submit" data-toggle="modal" data-target="#editInbox"
                                        class="btn btn-sm bg-info text-center text-white mt-6 btn-block ">
                                        Edit Data
                                    </button>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <hr>
                                    <h6>Informasi Retensi Surat</h6>
                                    <table class="table table-responsive">
                                        <tr>
                                            <td width=30%>Retensi Tahun Aktif Surat</td>
                                            <td width=70% class="text-wrap">{{ $data->active_year }}</td>
                                        </tr>

                                        <tr>
                                            <td max-width=30%> Retensi Tahun Inaktif Surat</td>
                                            <td width=70% class="text-wrap">{{ $data->inactive_year }}</td>
                                        </tr>
                                        <tr>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Diteruskan Kepada</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('archivist_dispositon_add', $data->inboxID) }}" method="post">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="set_klasifikasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('set_class_archivist', $data->inboxID) }}" method="post">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="set_retensi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('set_retention_archivist', $data->inboxID) }}" method="post">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="set_lokasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('set_location_archivist', $data->inboxID) }}" method="post">
                        {{ csrf_field() }}
    ...
    <script>
        $(document).ready(function() {
            var table = $('.dispos_datatable').DataTable({
                ...
                "processing": true,
                "ajax": {
                    "url": "{{ route('archivist_dispositon', $data->inboxID) }}",
                    "dataType": "json",
    ...
    <script>
        $(document).ready(function() {
            $('#text_disposisi').summernote({
                'height': '200',
                toolbar: false,
                placeholder: 'Masukkan Instruksi Dispisisi Anda'
            });
        });
    </script>
@endsection
